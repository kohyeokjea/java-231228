...
public class B_Switch {
	...
	public static void main(String[] args) {
		...
		case 1: // 섭씨 -> 화씨
			...
			System.out.println("섭씨 " + temperature + "도는 화씨로 " + fahrenheit + "이다.");
			break;
		case 2: // 화씨 -> 섭씨
			double celsius = (temperature - 32) * 5 / 9;
			System.out.println("화씨 " + temperature + "도는 섭씨로 " + celsius + "이다.");
			break;
		default:
