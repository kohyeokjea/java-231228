...
public class A_If {
	...
	public static void main(String[] args) {
		...
		// if문
		// : 조건에 따라 실해시키고자 하는 로직(프로세스)이 다를 때 사용하는 구문
		...
		// if문의 경우 코드 블럭에 오는 코드가 하나의 구문이면 {} 생략이 가능
		if (age > 19)
			System.out.println("성인입니다.");
		...
		Scanner functionDate = new Scanner(System.in);
		...
		x = functionDate.nextInt();
		System.out.println("y값을 입력하세요.");
		y = functionDate.nextInt();
