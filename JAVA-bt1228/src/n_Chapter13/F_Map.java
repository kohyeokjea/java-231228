...
// - 값의 중복 허용: 값은 중복이 가능
// - 순서는 대부분의 Map 구현체는 순서 보장 X / LinkedHashMap은 예외
...
// 2. LinkedHashMap
// : 삽입 순서를 유지
// : 요소의 삽입 순서가 중요하고 빠른 검색이 필요할 때 사용

// 3. TreeMap
// : 키-값 쌍을 트리에 저장, 키에 따라 정렬되어 저장
// : 키에 null 값 허용 X (값은 그래도 허용)
...
public class F_Map {
	...
	public static void main(String[] args) {
		...
		// 값 가져오기
		System.out.println(students.get("oh")); // 26

		// 값 제거
		students.remove("ko");
		System.out.println(students); // {oh=26, jin=28}

		// 키를 통한 값을 검사
		System.out.println(students.containsKey("jin")); // true
