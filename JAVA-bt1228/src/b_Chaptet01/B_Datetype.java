...
public class B_Datetype {
	...
	public static void main(String[] args) {
		...
		// float: 4바이트 소수점. 숫자 뒤에 알파벳 F 또는 f를 써서 float형임을 표시
		...
		//		
		// String str = 'This is String Type'; <- 다음 시간에 사용
