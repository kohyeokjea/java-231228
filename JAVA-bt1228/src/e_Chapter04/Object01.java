...
public class Object01 {
	...
	public static void main(String[] args) {
		...
		// 1. 클래스
		// : 객체를 생성하기 위한 템플릿, 데이터(속성)와 메서드(행동)을 정의
		// ex) '자동차' 클래스
		// - 속성(색상, 브랜드, 모델 등)
		// - 메서드(주행, 정지, 속도 변경 등)
		...
		// 엔진을 조작하기 위해서는 시동 버튼, 가속 페달 등으 사용
