...
public class Method02 {
	...
	// main: 메서드명
	// (String[] args): 메서드 매개변수로 String타입의 배열을 전달 받음
	// - 자바 설치 시
	...
	public static void main(String[] args) {
		...
		// 메서드 정의 후 호출이 되어야만 구현부{} 내의 무장이 수행
		// 메서드 호출 방법
		// : 메서드(메서드 정의 시 작성한 매개변수 작성);
		e1.print99danAll();
		...
		// 인수(인자)란?
		// : 매서드를 호출할 때 소괄호() 안에 지정해준 값
		// : 인자의 개수와 순서는 반드시 호출된 메서드에 선언된 매개변수와 일치
		// e1.add(10, 20, 30); - Error (매개변수 2개인 메서드에 인자 3개 전달 X)
		// e1.add(10.0, 20.0); - Error (double 타입은 int 타입에 사용 X)
		e1.add('a', 'b'); // char 타입은 int 타입으로 자동 형 변환
