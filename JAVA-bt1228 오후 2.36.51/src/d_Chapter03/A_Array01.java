...
public class A_Array01 {
	...
	public static void main(String[] args) {
		...
		// 문자열(''), 숫자형(0), 논리형(false) 가 기본값이다.

		// 요소: 배열 내의 각각의 데이터
		System.out.println(array); // [I@77ec78b9: 배열이 담긴 주소
		...
		// : 배열의 길이는 고정, 한 번 생성된 배열의 크기는 병경 불가
		int[] myArray = { 1, 4, 2, 5, 6, 3, 8, 9, 1, 3, 5, 8, 5 };
		// 배열명.length
