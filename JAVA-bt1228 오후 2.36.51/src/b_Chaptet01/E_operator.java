...
public class E_operator {
	...
	public static void main(String[] args) {
		...
		// 해당 수가 2의 배수인지를 확인
		// : 해당 수를 2로 나우어서(%) 나머지가 0인 경우 확인 가능
		...
		// : 변수명 앞에 증가 연산자 사용 시 해당 변수를 즉가 증가

		System.out.println(integer++); // 11 (증가 X)
		// : 변수명 뒤에 연산자 사용 시 해당 변수를 다음 호출 시 증가
		...
		boolean bool1 = 10 == 12; // false
		System.out.println(bool1); // false 출력
		...
		// &&(앰퍼샌드) : AND 연산자
		// : 좌항과 우항이 모드 true 일 때 true, 하나라도 false인 경우 false
		int andOper1 = 8;
		int andOper2 = 3;
